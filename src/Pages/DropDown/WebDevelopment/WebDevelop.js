...
import WebDev from '../../../assest/Banner/webdevlop.jpg';
...
const WebDevelop = () => {
    ...
    const content1 = {
        ...
        description: [
            "Being a web development company, we provide you one of the best services in this field that are cost-efficient too. Our team of certified and well-experienced web developers have a great command over platforms like PHP, Laravel, React JS, and many more."
        ]
    };
    ...
    const content2 = {
        ...
        description: [
            "Our Web Development Company provides services including several phases of production and maintenance so that we can deliver the project on time with no complications."
        ]
    };
