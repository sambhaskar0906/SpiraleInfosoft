...
const HybridApp = () => {
    ...
    const content = {
        ...
        description: [
            ...
            "We, as a Hybrid App development company, ensure that the services provided by us are high in quality and performance.",
    ...
    const content1 = {
        ...
        description: [
            "Being a Hybrid App development company, we provide you one of the best services in this field that are cost-efficient too. Our team of certified and well-experienced web developers have a great command over platforms like PHP, Laravel, React JS, and many more."
        ]
    };

    const content2 = {
        title: "Why choose TCSPL for the Hybrid App Development Services ?",
        description: [
            "Our Hybrid App Development Company provides services including several phases of production and maintenance so that we can deliver the project on time with no complications."
        ]
    };
    ...
    const services = [
        ...
        {
            heading: "Custom Hybrid App Development Services",
            description: "Our Hybrid App development company and its team of talented and dedicated developers take care of each and every requirement and need of the client and their project. Knowing our client’s requirements, we provide them with well-suited solutions for their business."
        },
        {
            heading: "Enterprise Hybrid App Development Services",
