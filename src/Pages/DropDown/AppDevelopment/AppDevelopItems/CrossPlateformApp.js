...
import WebDev from '../../../../assest/Banner/crossbanner.jpg';
...
const CrossPlateformApp = () => {
    ...
    const content = {
        title: "Cross Plateform Development Company in India",
        description: [
            ...
            "We, as a Cross Plateform development company, ensure that the services provided by us are high in quality and performance.",
    ...
    const content1 = {
        title: "Cross Plateform Development Services",
        description: [
            "Being a Cross Plateform development company, we provide you one of the best services in this field that are cost-efficient too. Our team of certified and well-experienced web developers have a great command over platforms like PHP, Laravel, React JS, and many more."
        ]
    };

    const content2 = {
        title: "Why choose TCSPL for the Cross Plateform Development Services ?",
        description: [
            "Our Cross Plateform Development Company provides services including several phases of production and maintenance so that we can deliver the project on time with no complications."
        ]
    };
    ...
    const services = [
        ...
        {
            heading: "Custom Cross Plateform Development Services",
            description: "Our web development company and its team of talented and dedicated developers take care of each and every requirement and need of the client and their project. Knowing our client’s requirements, we provide them with well-suited solutions for their business."
        },
        {
            heading: "Enterprise Cross Plateform Development Services",
