...
import WebDev from '../../../../assest/Banner/reactnativebanner.jpg';
...
const ReactNativeApp = () => {
    ...
    const content = {
        title: "React Native Development Company in India",
        description: [
            ...
            "We, as a React Native  development company, ensure that the services provided by us are high in quality and performance.",
    ...
    const content1 = {
        ...
        description: [
            "Being a React Native  development company, we provide you one of the best services in this field that are cost-efficient too. Our team of certified and well-experienced web developers have a great command over platforms like PHP, Laravel, React JS, and many more."
        ]
    };

    const content2 = {
        title: "Why choose TCSPL for the React Native  Development Services ?",
        description: [
            "Our React Native  Development Company provides services including several phases of production and maintenance so that we can deliver the project on time with no complications."
        ]
    };
    ...
    const services = [
        ...
        {
            heading: "Custom React Native  Development Services",
            description: "Our React Native  development company and its team of talented and dedicated developers take care of each and every requirement and need of the client and their project. Knowing our client’s requirements, we provide them with well-suited solutions for their business."
        },
        {
            heading: "Enterprise React Native  Development Services",
